...
const FixStyleOnlyEntry = require('webpack-fix-style-only-entries');
...
const fixStyle = new FixStyleOnlyEntry();
...
const generateHTMLPlugins = () => glob.sync('./src/*.html').map((dir) => {
  ...
  console.log(path.join(config.root, config.paths.src, 'page', filename));
